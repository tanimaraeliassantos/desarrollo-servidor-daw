    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/camiones/**").hasRole("EMPRESA")
                .requestMatchers("/api/mercancias/estadisticas/**").hasAnyRole("EMPRESA", "CONDUCTOR")
                .requestMatchers("/api/conductores/**").hasAnyRole("EMPRESA", "CONDUCTOR")

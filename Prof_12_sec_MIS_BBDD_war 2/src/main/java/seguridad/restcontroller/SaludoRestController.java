...
import seguridad.model.repository.UsuarioRerpository;
...
public class SaludoRestController {
	...
	public String hola(Authentication auth, HttpSession misesion) {
		...
		Usuario usuario = usuarioRerpository.findById(auth.getName()).orElse(null);
	...
	public String adios() {
		...
		return "Bye bye " + auth.isAuthenticated();
	}
